        ...
        material.grid = $("#grIdPenjualan").DataTable({
            ...
            "columns": [
                ...
                { "data": "Status" },
                {
                    "data": "IdPenjualan",
                    "render": function( data, type, full, meta){
                        return "<button class='btn btn-success' onClick='material.selectdata("+data+")'><i class='fa fa-pencil'></i></button> &nbsp; <button class='btn btn-danger' onClick='material.remove("+data+")'><i class='fa fa-trash'></i></button> <button class='btn btn-warning' onClick='material.cetak("+data+")'><i class='fa fa-print'></i></button>";
                    }
                }
            ],
        });
