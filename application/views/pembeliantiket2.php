            ...
            <div class="x_content" data-bind="with:material">
                ...
                <div class="row" data-bind="visible:Mode() === ''">
                    <div class="col-md-12 padding-filter">
                        <div class="col-md-5">
                            <button class="btn btn-sm btn-primary" data-bind="click:add"><span class="glyphicon glyphicon-plus"></span>Beli Tiket</button>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8" style="display:inline-block">
                                ...
                                <input name="txtfilter" class="form-input form-control filter-textinline" data-bind="value:FilterText" placeholder="filter" placeholder="No Pembelian" />
                                &nbsp;&nbsp;
                ...
                <div class="row" data-bind="visible:Mode() === 'Update' || Mode() === 'Save'">
                    <div class="col-md-12 padding-filter">
                        ...
                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target=".modal-doku"><span class="glyphicon glyphicon-floppy-disk"></span> Duitku</button>

                        <!-- <button class="btn btn-sm btn-danger" data-bind="click:remove"><span class="glyphicon glyphicon-trash"></span> Delete</button> -->
                    </div>
                    <form class="col-md-12 form-tiket" action="<?php echo site_url('Penjualannewcontroller/duitkubayar') ?>" method="post" data-bind="with:Recordmaterial">
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">No Pembelian</label>
                            <div class="col-md-8">
                                <input name="NoPenjualan" class="form-input form-control" type="number" data-bind="value:NoPenjualan" readonly />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Tanggal</label>
                            <div class="col-md-8">
                                <input name="Tanggal" class="form-input form-control" type="text" data-bind="value: Tanggal" readonly />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Member</label>
                            <div class="col-md-7">
                                <input name="NoMember" class="form-input form-control" type="text" data-bind="value:NoMember" readonly />
                            </div>
<!--                             <div class="col-md-1">
                                <button  type="button" class="btn btn-primary" data-toggle="modal" data-target=".modal-member">Pilih</button>
                            </div> -->
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Nama</label>
                            <div class="col-md-8">
                                <input name="Nama" class="form-input form-control" type="text" data-bind="value:Nama" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Ktp</label>
                            <div class="col-md-8">
                                <input name="Ktp" class="form-input form-control" type="text" data-bind="value:Ktp" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Kelas</label>
                            <div class="col-md-8">
                                <select class="form-control kelas" name="IdKelas" data-bind="value: IdKelas,event:{ change: material.changekelas}">
                                <?php foreach ($kelas as $data) { ?>
                                <option value="<?php echo $data->IdKelas; ?>" harga="<?php echo $data->Harga; ?>"><?php echo $data->Kelas; ?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </div>
                        <!-- <div class="col-md-6">
                            <label class="col-md-4 filter-label">Pelajar</label>
                            <div class="col-md-8">
                                <select class="form-control kelas" name="IdKelas" data-bind="value: Kategori,event:{ change: material.changekategori}">
                        ...
                        <div class="col-md-6" data-bind="visible: material.Recordmaterial.NoMember() != ''">
                            ...
                            <div class="col-md-7">
                                <input name="DiskonPromo" class="form-input form-control" type="text" data-bind="value:DiskonPromo" readonly />
                            </div>
                            <div class="col-md-1">
                                <button  type="button" class="btn btn-primary" data-toggle="modal" data-target=".modal-promo">Pilih</button>
                            </div>
                        </div>
                        <input type="hidden" name="detil"/>
                        <input type="hidden" name="detil2"/>
                        <input type="hidden" name="Email" data-bind="value: Email"/>
                        <input type="hidden" name="Phone" data-bind="value: Phone"/>
                        <input type="hidden" name="IdMember" data-bind="value: IdMember"/>
                        <input type="hidden" name="Status" data-bind="value: Status"/>
                        <input type="hidden" name="IdPromo" data-bind="value: IdPromo"/>
                        <input type="hidden" name="TipePenjualan" data-bind="value: TipePenjualan"/>
                        <input type="hidden" name="PaymentDuitku" data-bind="value: PaymentDuitku"/>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Total Harga</label>
                            <div class="col-md-8">
                                <input name="TotalHarga" class="form-input form-control" type="text" data-bind="value:TotalHarga" readonly />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <button  type="button" class="btn btn-primary" data-toggle="modal" data-target=".modal-tiket">Add Tiket</button>
                            <div class="col-md-12">
...
<script>
    ...
    material.add = function(){
        ...
        material.Mode('Save');
        material.datadetil([]);
        material.selectdataMember(material.Recordmaterial.IdMember());
    }
            ...
            success : function(res) {
                ...
                for(var i in res.Data){
                    ...
                    if (i == 0){
                        ...
                        doc.text(370, 105, "Jam :");
                        doc.text(410, 105, res.Data[i].Jam);
                        ...
                        doc.text(370, 105+newline, "Jam :");
                        doc.text(410, 105+newline, res.Data[i].Jam);
                    }
    ...
    $(document).ready(function () {
        ...
        material.grid = $("#grIdPenjualan").DataTable({
            ...
            dom: 'Bfrtip',
            "ajax": {
                "url": "<?php echo site_url('Penjualannewcontroller/getData2') ?>",
                "type": "POST",
                "data": function(d){ 
                    d['filtervalue'] = material.FilterValue();
                    d['filtertext'] = material.FilterText();
                    d['IdMember'] = <?php echo $login['IdMember']; ?>;
                    return d; 
                } ,
                "dataSrc": function (json) {
                    // json.draw = 1;
