<script>
    ...
    var material = {
        Recordmaterial: ko.mapping.fromJS(model.diskonModel),
        Listmaterial: ko.observableArray([]),
        Mode: ko.observable(''),
        FilterText: ko.observable(''),
        DataFilter: ko.observableArray(['Diskon']),
        FilterValue: ko.observable('Diskon'),
    }
    material.selectdata = function(id) {
        $.ajax({
            url: "<?php echo site_url('Diskoncontroller/getDataSelect') ?>",
            type: 'post',
            dataType: 'json',
            data : {id: id},
            ...
            <div class="x_content" data-bind="with:material">
                ...
                <div class="row" data-bind="visible:Mode() === ''">
                    <div class="col-md-12 padding-filter">
                        <div class="col-md-5">
                            <button class="btn btn-sm btn-primary" data-bind="click:add"><span class="glyphicon glyphicon-plus"></span> Add Diskon</button>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <table id="grIdDiskon" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped" id="tableik">
                            <thead>
                                <tr>
                                    <th>Member</th>
                                    <th>Min Pembelian</th>
                ...
                <div class="row" data-bind="visible:Mode() === 'Update' || Mode() === 'Save'">
                    ...
                    <div class="col-md-12" data-bind="with:Recordmaterial">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" data-bind="value: Member">
                        ...
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Min Pembelian</label>
                            <div class="col-md-8">
                                <input name="txtmaterialname" class="form-input form-control" type="number" data-bind="value:MinPembelian" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Diskon</label>
                            <div class="col-md-8">
                                <input name="txtmaterialname" class="form-input form-control" type="number" data-bind="value:Diskon" />
                            </div>
                        </div>
                        <div class="col-md-6">
...
<script>
    material.backForm = function(){
        material.Mode('');
        ko.mapping.fromJS(model.diskonModel,material.Recordmaterial);
    }
    ...
    material.save = function(){
        var url = "<?php echo site_url('Diskoncontroller/save') ?>";
        if(material.Mode() === 'Update')
            url = "<?php echo site_url('Diskoncontroller/update') ?>";
    ...
    material.remove = function(id){
        $.ajax({
            url: "<?php echo site_url('Diskoncontroller/delete') ?>",
            type: 'post',
            dataType: 'json',
            data: {id: id},
            success : function(res) {
    ...
    $(document).ready(function () {
        material.grid = $("#grIdDiskon").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('Diskoncontroller/getData') ?>",
                "type": "POST",
                "data": function(d){ 
