            ...
            <div class="x_content" data-bind="with:material">
                ...
                <div class="row" data-bind="visible:Mode() === 'Update' || Mode() === 'Save'">
                    ...
                    <div class="col-md-12" data-bind="with:Recordmaterial">
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Min Tiket</label>
                            <div class="col-md-8">
                                <input name="txtmaterialname" class="form-input form-control" type="number" data-bind="value:MinTiket" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Diskon Promo (%)</label>
                            <div class="col-md-8">
                                <input name="txtmaterialname" class="form-input form-control" type="number" data-bind="value:DiskonPromo" />
                            </div>
                        </div>
                    </div>
                </div>
