<script>
    ...
    var material = {
        Recordmaterial: ko.mapping.fromJS(model.stadionModel),
        Listmaterial: ko.observableArray([]),
        Mode: ko.observable(''),
        FilterText: ko.observable(''),
        DataFilter: ko.observableArray(['NamaStadion']),
        FilterValue: ko.observable('NamaStadion'),
    }
            ...
            <div class="x_content" data-bind="with:material">
                ...
                <div class="row" data-bind="visible:Mode() === ''">
                    <div class="col-md-12 padding-filter">
                        <div class="col-md-5">
                            <button class="btn btn-sm btn-primary" data-bind="click:add"><span class="glyphicon glyphicon-plus"></span> Add Stadion</button>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="row" data-bind="visible:Mode() === 'Update' || Mode() === 'Save'">
                    ...
                    <div class="col-md-12" data-bind="with:Recordmaterial">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input name="txtmaterialname" class="form-input form-control" type="text" data-bind="value:NamaStadion" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="col-md-4 filter-label">Kapasitas</label>
                            <div class="col-md-8">
                                <input name="txtmaterialname" class="form-input form-control" type="number" data-bind="value:Kapasitas" />
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    material.backForm = function(){
        material.Mode('');
        ko.mapping.fromJS(model.stadionModel,material.Recordmaterial);
    }
    ...
    material.save = function(){
        var url = "<?php echo site_url('Stadioncontroller/save') ?>";
        if(material.Mode() === 'Update')
            url = "<?php echo site_url('Stadioncontroller/update') ?>";
    ...
    material.remove = function(id){
        $.ajax({
            url: "<?php echo site_url('Stadioncontroller/delete') ?>",
            type: 'post',
            dataType: 'json',
            data: {id: id},
            success : function(res) {
    ...
    $(document).ready(function () {
        material.grid = $("#grIdStadion").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
