            ...
            <div class="x_content" data-bind="with:material">
                ...
                <div class="row" data-bind="visible:Mode() === ''">
                    <div class="col-md-12 padding-filter">
                        <div class="col-md-5">
                            <button class="btn btn-sm btn-primary" data-bind="click:add"><span class="glyphicon glyphicon-plus"></span> Add Member</button>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="row" data-bind="visible:Mode() === 'Update' || Mode() === 'Save'">
                    ...
                    <div class="col-md-12" data-bind="with:Recordmaterial">
                        <div class="col-sm-12">
                            <div class="well" data-bind="fileDrag: model.fileData">
                                <div class="form-group row">
                                  <div class="row">
                                    <img style="height: 300px; width: 50%; margin-left:20px;" class="img-rounded  thumb" data-bind="attr: { src: model.fileData().dataURL }, visible: model.fileData().dataURL">
                                    <div data-bind="ifnot: model.fileData().dataURL">
                                        <label class="drag-label">Drag file here</label>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <input type="file" data-bind="fileInput: model.fileData, customFileInput: {
        ...
        material.grid = $("#grIdMember").DataTable({
            ...
            "ajax": {
                ...
                "dataSrc": function (json) {
                    ...
                    material.StartIndex(json.Start);
            ...
            "columns": [
                ...
                { "data": "NoMember","render": function( data, type, full, meta){
                    material.StartIndex(parseInt(material.StartIndex())+1);
                    return "<span>"+material.StartIndex()+"</span>"
                } },
                { "data": "NamaMember" },
                { "data": "NoKtp" },
                { "data": "Status" },
